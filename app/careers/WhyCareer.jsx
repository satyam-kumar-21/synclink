      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">
            Why Join Synclink Technologies?
          </h2>
          <p className="text-gray-700 text-base md:text-lg">
            Synclink Technologies promotes a culture of impacting users’ lives with our innovations. We are looking for people who share our vision and want to contribute to it. Our company facilitates an environment with open communication, togetherness, and equal opportunities.
          </p>
          <p className="text-gray-700 text-base md:text-lg">
